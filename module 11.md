...
int main()
{
int n1,n2,n3,n4,greater; scanf("%d%d%d%d",&n1,&n2,&n3,&n4);
 greater=max_of_four(n1,n2,n3,n4); printf("%d",greater);
}
```

Output:
![image](https://github.com/user-attachments/assets/c06d8232-d80b-4bd9-bb40-3666f2574c3d)
...
```
Output:
![image](https://github.com/user-attachments/assets/fb50f2ac-2874-4455-99b7-a3653bb5c4d9)
...
{
int noshel,noque; scanf("%d%d",&noshel,&noque);
...
```
Output:
![image](https://github.com/user-attachments/assets/ff400e5b-0a9c-42da-b290-2917a4c5fcfa)
